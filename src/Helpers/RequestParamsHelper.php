...
class RequestParamsHelper extends Helper {
    ...
    protected $requestfilter = [
        'params' => [
            ...
            'PennyStocks' => FILTER_SANITIZE_NUMBER_INT,
            'GrowthPotential' => FILTER_SANITIZE_NUMBER_INT,
            'HedgePercentage' => FILTER_SANITIZE_NUMBER_INT,
            'BalanceRR' => FILTER_SANITIZE_NUMBER_INT,
            'Watchlists' => FILTER_SANITIZE_NUMBER_INT,
            ...
            'DataProvider' => FILTER_SANITIZE_NUMBER_INT,
        ],
        'options' => [
